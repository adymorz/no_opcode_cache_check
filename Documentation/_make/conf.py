# -*- coding: utf-8 -*-
#
# Hide opcode cache check in system environment check documentation build configuration file, created by
# TYPO3 extension sphinx on Sat, 05 Oct 2013 15:28:00 +0200.
#
...
project = u'Hide opcode cache check in system environment check'
copyright = u'2013, Adrian Dymorz'
...
htmlhelp_basename = 'Hideopcodecachecheckinsystemenvironmentcheckdoc'
...
latex_documents = [
    ('Index', 'Hideopcodecachecheckinsystemenvironmentcheck.tex', u'Hide opcode cache check in system environment check',
     u'Adrian Dymorz', 'manual'),
]
...
pdf_documents = [
    ('Index', 'Hideopcodecachecheckinsystemenvironmentcheck', u'Hide opcode cache check in system environment check',
     u'Adrian Dymorz'),
]
...
texinfo_documents = [
    ('Index', 'Hideopcodecachecheckinsystemenvironmentcheck', u'Hide opcode cache check in system environment check',
     u'Adrian Dymorz', 'Hide opcode cache check in system environment check', 'One line description of project.',
     'Miscellaneous'),
]
